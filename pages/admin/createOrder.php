...
<main>
    ...
    <div class="container-flex">
        ...
        <div class="infoCustomer">
            <div> Mã hóa đơn<input type="text" name="idOrder" id="" value="<?= $nextOrderId ?>"></div>
            ...
            <div>
                ...
                <select name="status" id="">
                    ...
                    <option value="cancelled">Đã hủy</option>
                </select>
            </div>
            <button type="button" onclick="submitOrder()">Lưu đơn hàng</button>
        </div>
        <div>
            <p>Tiền dịch vụ: <span id="total_price_service"></span></p>
