...
// File này CHỈ chứa HTML và CSS cho modal.
// Toàn bộ JavaScript đã được chuyển sang book.php
?>

<style>
    /* CSS dành riêng cho nội dung modal chẩn đoán AI */
    ...
    .diagnosis-result {
        ...
        font-size: 1.1em;
        color: #0056b3;
        display: none; /* Ẩn cho đến khi có kết quả */
        text-align: left; /* Căn trái cho kết quả */
    }
